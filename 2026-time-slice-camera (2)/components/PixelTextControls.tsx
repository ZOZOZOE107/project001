    ...
    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-30 flex flex-col items-center gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="relative group">
        <input
          ...
          className="bg-transparent border-b border-white/30 text-white font-light text-xl text-center outline-none focus:border-white transition-colors w-64 uppercase tracking-widest py-1"
      ...
      <div className="flex items-center gap-4 mt-2">
         <span className="text-[10px] text-white/70 font-medium tracking-widest">SIZE</span>
         ...
         <span className="text-[10px] text-white/70 font-medium tabular-nums w-6">{scale.toFixed(1)}</span>
      </div>
    </div>
  );
};
