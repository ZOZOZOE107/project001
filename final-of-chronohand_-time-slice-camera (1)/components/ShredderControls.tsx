  ...
  return (
    <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-30 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center gap-5 px-6 py-3">
        ...
        <span className="text-[10px] font-sans font-medium text-white uppercase tracking-widest select-none drop-shadow-md opacity-90">
          Density
        </span>
        ...
        <span className="text-xs font-sans font-normal text-white w-6 text-right select-none tabular-nums drop-shadow-md">
