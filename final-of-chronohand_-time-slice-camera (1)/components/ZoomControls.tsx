...
const ZoomControls: React.FC<ZoomControlsProps> = ({ zoom, onZoomChange, min = 0.5, max = 2 }) => {
  return (
    <div className="flex items-center gap-2 pointer-events-auto">
        ...
        <span className="text-[7px] text-black/60 font-sans font-bold w-6 text-center">{min}x</span>
        ...
        {/* Font size reduced to text-[7px] to match footer scale */}
        <span className="text-[7px] text-black/60 font-sans font-bold w-6 text-center">{(zoom).toFixed(1)}x</span>
    </div>
  );
};
