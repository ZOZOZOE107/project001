...
const Controls: React.FC<ControlsProps> = ({ settings, onSettingsChange }) => {
  ...
  return (
    <>
      ...
      {/* Desktop View: Column of Horizontal Sliders */}
      <div className="hidden md:flex absolute top-6 left-6 flex-col gap-6 z-50 text-white select-none pointer-events-auto mix-blend-difference">
